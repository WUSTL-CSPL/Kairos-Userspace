...
function(llvmir_attach_opt_pass_target)
  ...
  foreach(IN_LLVMIR_FILE ${IN_LLVMIR_FILES})
    ...
    message("Output file : ${FULL_OUT_LLVMIR_FILE}")
...
function(llvmir_attach_library)
  ...
  message("******Added library : ${TRGT}")
  message("******Attached arguments : ${LLVMIR_ATTACH_UNPARSED_ARGUMENTS}")
  message("******Full LLVMIR files : ${IN_FULL_LLVMIR_FILES}")
...
function(llvmir_attach_bc_target_cspl)
  set(options ATTACH_TO_DEPENDENT_STATIC_LIBS)
  set(oneValueArgs TARGET DEPENDS)
  set(multiValueArgs)
  cmake_parse_arguments(LLVMIR_ATTACH
  ...
  foreach(IN_FILE ${IN_FILES})
    ...
    set(CMD_ARGS "-emit-llvm" "-fPIC" ${IN_STANDARD_FLAGS} ${IN_LANG_FLAGS}
      ${IN_COMPILE_OPTIONS} ${CURRENT_COMPILE_FLAGS} ${CURRENT_DEFS}
      ${IN_INCLUDES})
