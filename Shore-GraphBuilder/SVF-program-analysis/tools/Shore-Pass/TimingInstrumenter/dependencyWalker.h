...
public:
    ...
    SVFIR* _svfir;
    SymbolTableInfo::ValueToIDMapTy& _valSymMap;
    SVFG* _svfg;
    SVFIR* _pag;
    PTACallGraph* _ptacallgraph;
//    Instrumenter * instrumenter;
    ...
    SymbolTableInfo::ValueToIDMapTy& valSymMap, SVFG* svfg)
        : M(m),
          _svfModule(svfModule),
          _valSymMap(valSymMap),
          _svfg(svfg),
          _pag(pag),
          saveState(false),
          isControlDep(false),
        ...
        _ptacallgraph = _pta->getPTACallGraph();
    }


    Set<Instruction*> find_difference(Set<BasicBlock*>);
    Set<Instruction*> find_difference_group(
        std::vector<Set<BasicBlock*>> vecbbset);
    Set<Instruction*> find_inter_pro_difference(Set<BasicBlock*>,
                                                Set<SVFGNode*>, SVFGNode*);
    Set<SVFFunction*> getDistinguishFunction(
